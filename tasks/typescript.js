...
gulp.task('watch-ts', function () {
    return gulp.watch(tsFiles, function (file) {
        ...
        return compileTs(file.path, true,true);
    });
});
...
gulp.task('tsc-temp', ['clean-ts'], function () {
...
gulp.task('tsc-app-temp', ['clean-ts-app'], function () {
...
function compileTs(files, watchMode, inTemp) {
    ...
    return res.js
        ...
        .pipe(gulp.dest(inTemp?config.temp.path:config.root));
}